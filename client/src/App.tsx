...
import Landing from "@/pages/animated-landing";
...
import AdminDatabaseStats from "@/pages/admin-database-stats";
  ...
  return (
    <>
      ...
      <Switch>
        ...
        {isAdmin && <Route path="/admin/database" component={AdminDatabaseStats} />}
